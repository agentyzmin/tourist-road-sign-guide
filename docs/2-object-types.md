...
Музеї, заповідники, заклади музейного типу. Актуальний список закладів можна отримати за запитом до Мінкульту на пошту zapyty@mkip.gov.ua.
...
<p class="caption">Таблиця 2.1 — Граничні відстані до точок інтересу залежно від їхньої значущості</p>

<table>
  <tr>
   <td><strong>Сума балів</strong>
   </td>
   <td><strong>Гранична відстань, км</strong>
   </td>
  </tr>
  <tr>
   <td>2
